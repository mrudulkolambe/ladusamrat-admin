                ...
                <div className="pr-4">
                    <div className="grid grid-cols-2 py-2">
                        ...
                        <div className="w-full">
                            <input type="email" value={productName} id="email" className="w-full mr-4 bg-gray-50  text-gray-900 text-sm rounded-lg block  p-4 border-2 " placeholder="name@flowbite.com" required />
                        </div>
                    </div>
                    <div className="grid grid-cols-2 py-2">
                        <div className="w-full flex justify-center items-center">
                            <label className="block w-1/2 items-center text-gray-800   font-medium text-sm">Product Description</label>
                        </div>
                        <div className="w-full">
                            <input type="email" value={productDescription} id="email" className="w-full mr-4 bg-gray-50  text-gray-900 text-sm rounded-lg block  p-4 border-2 " placeholder="name@flowbite.com" required />
                        </div>
                    </div>
                    <div className="grid grid-cols-2 py-2">
                        <div className="w-full flex justify-center items-center">
                        ...
                        <div className="w-full">
                            <input type="email" id="email" value={productPrice} className="w-full mr-4 bg-gray-50  text-gray-900 text-sm rounded-lg block  p-4 border-2 " placeholder="name@flowbite.com" required />
                        </div>
                    </div>
                    <div className="grid grid-cols-2 py-2">
                        <div className="w-full flex justify-center items-center">
                            ...
                            <div className="flex items-center justify-center w-full">
                                <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 hover:bg-gray-100 ">
                                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                        <svg className="w-8 h-8 mb-4 text-[#C21C20] " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                    ...
                    <div className="grid grid-cols-2 py-2">
                        <div className="w-full flex justify-center items-center">
                            <label className="block w-1/2 items-center text-gray-800   font-medium text-sm">Stock Status</label>
                        </div>
                        <div className="w-full">

                            <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select an option</label>
                            <select id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-4">
